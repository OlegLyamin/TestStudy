...
namespace common\models\student_group\search;
...
/**
 * StudentGroupSearch represents the model behind the search form of `common\models\student_group\StudentGroup`.
 */
